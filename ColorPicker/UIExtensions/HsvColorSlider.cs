    ...
    internal class HsvColorSlider : PreviewColorSlider {
        ...
        protected override void GenerateBackground() {
            if (this.SliderHsvType == "H") {
                var colorStart = this.GetColorForSelectedArgb(0);
                var colorEnd = this.GetColorForSelectedArgb(360);
            ...
            {
                var colorStart = this.GetColorForSelectedArgb(0);
                var colorEnd = this.GetColorForSelectedArgb(255);
                this.LeftCapColor.Color = colorStart;
                this.RightCapColor.Color = colorEnd;
                this.BackgroundGradient = new GradientStopCollection {
        ...
        private Color GetColorForSelectedArgb(int value) {
            switch (this.SliderHsvType) {
                ...
                case "S": {
                    var rgbtuple = ColorSpaceHelper.HsvToRgb(this.CurrentColorState.HSV_H, value / 255.0, this.CurrentColorState.HSV_V);
                    double r = rgbtuple.Item1, g = rgbtuple.Item2, b = rgbtuple.Item3;
                    return Color.FromArgb(255, (byte) (r * 255), (byte) (g * 255), (byte) (b * 255));
                }
                case "V": {
                    var rgbtuple = ColorSpaceHelper.HsvToRgb(this.CurrentColorState.HSV_H, this.CurrentColorState.HSV_S, value / 255.0);
                    double r = rgbtuple.Item1, g = rgbtuple.Item2, b = rgbtuple.Item3;
                    return Color.FromArgb(255, (byte) (r * 255), (byte) (g * 255), (byte) (b * 255));
                }
