    ...
    internal class HslColorSlider : PreviewColorSlider {
        ...
        private Color GetColorForSelectedArgb(int value) {
            switch (this.SliderHslType) {
                ...
                case "S": {
                    var rgbtuple = ColorSpaceHelper.HslToRgb(this.CurrentColorState.HSL_H, value / 255.0, this.CurrentColorState.HSL_L);
                    double r = rgbtuple.Item1, g = rgbtuple.Item2, b = rgbtuple.Item3;
                    return Color.FromArgb(255, (byte) (r * 255), (byte) (g * 255), (byte) (b * 255));
                }
                case "L": {
                    var rgbtuple = ColorSpaceHelper.HslToRgb(this.CurrentColorState.HSL_H, this.CurrentColorState.HSL_S, value / 255.0);
                    double r = rgbtuple.Item1, g = rgbtuple.Item2, b = rgbtuple.Item3;
                    return Color.FromArgb(255, (byte) (r * 255), (byte) (g * 255), (byte) (b * 255));
                }
