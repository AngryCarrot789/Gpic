namespace ColorPicker.Models {
    public struct ColorState {
        ...
        private void RecalculateHSLFromRGB() {
            var hsltuple = ColorSpaceHelper.RgbToHsl(this._RGB_R, this._RGB_G, this._RGB_B);
        ...
        private void RecalculateHSLFromHSV() {
            var hsltuple = ColorSpaceHelper.HsvToHsl(this._HSV_H, this._HSV_S, this._HSV_V);
            double h = hsltuple.Item1, s = hsltuple.Item2, l = hsltuple.Item3;
            this._HSL_H = h;
            if (s != -1)
                this._HSL_S = s;
        ...
        private void RecalculateHSVFromRGB() {
            var hsvtuple = ColorSpaceHelper.RgbToHsv(this._RGB_R, this._RGB_G, this._RGB_B);
        ...
        private void RecalculateHSVFromHSL() {
            var hsvtuple = ColorSpaceHelper.HslToHsv(this._HSL_H, this._HSL_S, this._HSL_L);
            double h = hsvtuple.Item1, s = hsvtuple.Item2, v = hsvtuple.Item3;
            this._HSV_H = h;
            if (s != -1)
                this._HSV_S = s;
        ...
        private void RecalculateRGBFromHSL() {
            var rgbtuple = ColorSpaceHelper.HslToRgb(this._HSL_H, this._HSL_S, this._HSL_L);
        ...
        private void RecalculateRGBFromHSV() {
            var rgbtuple = ColorSpaceHelper.HsvToRgb(this._HSV_H, this._HSV_S, this._HSV_V);
            this._RGB_R = rgbtuple.Item1;
            this._RGB_G = rgbtuple.Item2;
            this._RGB_B = rgbtuple.Item3;
        }
